...
const Hero = () => {
  return (
    <section className="m-auto flex h-dvh max-w-6xl -translate-y-7 flex-col  items-center justify-center px-4 text-center md:flex-row md:justify-start  md:text-start ">
